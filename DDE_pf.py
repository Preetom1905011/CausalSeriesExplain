...
def ddeModel(Y, t, d, parameters):
    ...
    params, inf_rate, phi_s1, phi_s2, phi_a1, phi_a2, g_rate = parameters        
    # update parameter values based on Timepoint
    params = paramsUpdate2Test(params, t, inf_rate, phi_s1, phi_s2, phi_a1, phi_a2, g_rate, n, m)
...
# piecewise dynamics of parameters (User Defined)
def paramsUpdate2Test(params, t, inf_rate, phi_s1, phi_s2, phi_a1, phi_a2, g_rate, n, m):
    beta, beta_prime, phi_s_1, phi_s_2, phi_a_1, phi_a_2, g_beta = -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf
    params_new = deepcopy(params)
    ...
    if beta != -np.inf:
        ...
        params_new['beta'] = inf_rate[-1]
        params_new['beta_prime'] = params_new['beta'] * 1.2
        params_new['phi_s_1'] = phi_s1[-1]
        params_new['g_beta'] = g_rate[-1]

        
        params_new['phi_a_1'] = phi_a1[-1]
        params_new['phi_s_2'] = phi_s2[-1]
        params_new['phi_a_2'] = phi_a2[-1]
...
def runModel(init_cond, T_delay, params, duration, inf_rate, phi_s1, phi_s2, phi_a1, phi_a2, g_rate):
    ...
    lags = T_delay
    N_t = duration
    parameters = (params, inf_rate, phi_s1, phi_s2, phi_a1, phi_a2, g_rate)
